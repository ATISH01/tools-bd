        ...
        <div className="hero h-[72vh]" style={{backgroundImage: `url(https://i.ibb.co/qRkf8tk/banner-tools.png)`}}>
            ...
            <div className="hero-content text-center mt-auto text-neutral-content">
                <div className="max-w-md">
                    ...
                    <p className="mb-5 text-yellow-300">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
